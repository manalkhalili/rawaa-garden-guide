  ...
  const allPlants = [
    ...
    },
    {
      ...
      shortDescription: 'يعشق الإضاءة القوية غير المباشرة. ألوانه تصبح أجمل بالشمس. يحتاج ري منتظم ورطوبة جيدة. لا يحب التغيير المفاجئ في المكان أو البرودة.\n' +
          '\n' ,
      category: 'indoor' as const,
      fullDescription: 'الكروتون، نبات داخلي مميز بألوان أوراقه الزاهية والمتنوعة، يُضفي لمسة جمالية على المنازل والمكاتب. يمكن زراعته خارجيًا في المناطق ذات المناخ الاستوائي أو المعتدل الدافئ. ينمو حتى متر أو أكثر، ويحتاج لمساحة تسمح بانتشار أوراقه. حساس للتغيرات المفاجئة في البيئة وقد يتساقط أوراقه إذا تعرض للبرودة أو نقص الإضاءة.',
      careInstructions: 'يُفضل وضع الكروتون في مكان ذي ضوء ساطع غير مباشر، حيث تعزز الشمس ألوان أوراقه. يُروى عند جفاف التربة السطحية مع تجنب الإغراق. يحتاج لرطوبة معتدلة ويمكن رش أوراقه برذاذ الماء من حين لآخر. درجة الحرارة المثالية له تتراوح بين 18 إلى 29 مئوية، ويُفضل تجنب التيارات الباردة. يُسمد بسماد سائل متوازن (NPK) مرة شهريًا في الربيع والصيف، مع التوقف في الشتاء. لمكافحة الحشرات، يُستخدم زيت النيم كمبيد عضوي، أو مبيد حشري خفيف في حالة تفشي البق الدقيقي أو العناكب الحمراء.'
