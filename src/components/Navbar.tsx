      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            {/* Desktop Navigation */}
            <nav className="hidden md:flex items-center space-x-3 space-x-reverse rtl">
              <Link to="/" className="flex items-center text-black hover:text-rawaa-primary transition-colors mr-2">
                <Home className="ml-1 h-4 w-4 -mr-1" />
                <span>الرئيسية</span>
              </Link>
              <div className="flex items-center text-black hover:text-rawaa-primary transition-colors mr-2">
                <PlantsDropdown />
              </div>
              <Link to="/about" className="flex items-center text-black hover:text-rawaa-primary transition-colors mr-2">
